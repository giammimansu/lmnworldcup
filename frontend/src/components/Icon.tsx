// ============================================================================
// LMN WORLD CUP — Custom football icon set (port TSX dal design system)
...
const stroke: Record<IconName, ReactElement> = {
  ball: (
    <g key="ball">
  ...
  fire: (
    <g key="fire">
      ...
      <path
        d="M12 21A2.4 2.4 0 0 1 9.6 18.6C9.6 16.8 12 16.2 12 13.6C13.8 15.4 14.4 16.8 14.4 18.6A2.4 2.4 0 0 1 12 21Z"
        opacity="0.55"
      />
    </g>
  ),
  ...
  user: (
    <g key="user">
      ...
      <path d="M4.5 20C4.5 16 7.5 14 12 14C16.5 14 19.5 16 19.5 20" />
    </g>
  ),
  'prediction-arrow': (
...
const filledVariants: Partial<Record<IconName, ReactElement>> = {
  ball: (
    <g key="ball-f">
      <circle cx="12" cy="12" r="9" fill="currentColor" stroke="none" />
      <g
        stroke="var(--lmn-midnight-700, #090E1B)"
        strokeWidth="1.3"
        fill="none"
      ...
      >
        <polygon
          points="12,8 15.8,10.8 14.3,15.2 9.7,15.2 8.2,10.8"
          fill="var(--lmn-midnight-700, #090E1B)"
        />
  ...
  home: (
    <g key="home-f" fill="currentColor" stroke="none">
      <path d="M12 3L21 10.2V11.2H3V10.2Z" />
      <path d="M5 11.5H19V20H14V14.5H10V20H5Z" />
    </g>
  ),
  user: (
    <g key="user-f" fill="currentColor" stroke="none">
      <circle cx="12" cy="8" r="4" />
      <path d="M4 20.5C4 16 7.5 13.5 12 13.5C16.5 13.5 20 16 20 20.5Z" />
    </g>
  ),
}
...
export function Icon({
  ...
  const useFill = isFilled && filledVariants[name]
  const inner = useFill ? filledVariants[name] : stroke[name] || stroke.ball
  return (
    <svg
      width={size}
      height={size}
